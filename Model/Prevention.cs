...
namespace Efir.Model
{
    internal class Prevention
    {
        ...
        public Prevention(int id, string name, string description, int numOfRun, TimeSpan duration, int series, int numOfSeries, DateTime lastRun, string path)
        {
            this.Id = id;
            this.Name = name;
