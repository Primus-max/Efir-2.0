...
{
    /// <summary>
    /// Модель представления: Лекции
    /// </summary>
    internal class Lection
    {
        ...
        public Lection(int id, string name, string description, int numOfRun, TimeSpan duration, int series, int numOfSeries, DateTime lastRun, string path)
        {
            this.Id = id;
            this.Name = name;
