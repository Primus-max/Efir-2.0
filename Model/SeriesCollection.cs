...
{
    /// <summary>
    /// Хранилище папок с сериалами
    /// </summary>
    internal class SeriesCollection
    {
        ...
        public SeriesCollection(int id, string name, string? description, int numOfRun, int numOfSeries, DateTime lastRun, string path)
